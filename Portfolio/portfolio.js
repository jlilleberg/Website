  ...
  let url2description = {
    ...
    "https://github.com/jlilleberg/DeepLearning.Ai-Certifications/tree/main/TensorFlow%20Advanced%20Technique%20Specialization/Course%202%20-%20Custom%20and%20Distributed%20Training%20with%20TensorFlow":"In this course, I learned about Tensor objects, understood the difference between the eager and graph modes in TensorFlow, learned to use a TensorFlow tool to calculate gradients, built custom training loops using GradientTape and TensorFlow Datasets, learned the benefits of generating code that runs in graph mode, practiced generating this more efficient code automatically with TensorFlow’s tools, harnessed the power of distributed training to process more data and train larger models, faster, get an overview of various distributed training strategies.",
