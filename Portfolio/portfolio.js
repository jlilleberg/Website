  ...
  let url2description = {
    ...
    "https://github.com/jlilleberg/DeepLearning.Ai-Certifications/tree/main/TensorFlow%20Advanced%20Technique%20Specialization/Course%201%20-%20Custom%20Models%2C%20Layers%2C%20and%20Loss%20Functions%20with%20TensorFlow":"In this course, I compared Functional and Sequential APIs, discovered new models to build with the Functional API, including a Siamese network. I learned to build custom loss functions, build off of existing standard layers to create custom layers, customize a network layer with a lambda layer, understand the differences between them, learn what makes up a custom layer, and explore activation functions, build off of existing models to add custom functionality, learn how to define a custom class instead of using the Functional or Sequential APIs, build models that can be inherited from the TensorFlow Model class, and build a (ResNet) through defining a custom model class.",
    "https://github.com/jlilleberg/DeepLearning.Ai-Certifications/tree/main/TensorFlow%20Advanced%20Technique%20Specialization/Course%202%20-%20Custom%20and%20Distributed%20Training%20with%20TensorFlow":"In this course, I learned about Tensor objects, the fundamental building blocks of TensorFlow, understood the difference between the eager and graph modes in TensorFlow, learned to use a TensorFlow tool to calculate gradients, build custom training loops using GradientTape and TensorFlow Datasets to gain more flexibility and visibility with my model training, learned the benefits of generating code that runs in graph mode, practiced generating this more efficient code automatically with TensorFlow’s tools, harnessed the power of distributed training to process more data and train larger models, faster, get an overview of various distributed training strategies.",
